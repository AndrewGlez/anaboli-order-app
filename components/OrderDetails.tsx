...
export default function OrderDetails({ order, isEditing, onClose, onSave }: OrderDetailsProps) {
    ...
    <View style={[styles.container, { backgroundColor: colors.white, borderColor: colors.border }]}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          <Text style={[styles.sectionLabel, { color: colors.textLight }]}>Nombre de Gym</Text>
          {isEditing ? (
            <TextInput
              style={styles.input}
              value={gymName}
            ...
            <Text style={[styles.sectionContent, { color: colors.text }]}>{order.gymName}</Text>
          )}
        </View>

        <View style={styles.section}>
          <Text style={[styles.sectionLabel, { color: colors.textLight }]}>Estado</Text>
          {isEditing ? (
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionLabel, { color: colors.textLight }]}>Productos</Text>
            ...
            <View key={index} style={styles.productRow}>
              {isEditing ? (
                ...
                <View style={styles.productItem}>
                  <View style={[styles.productTypeContainer, { backgroundColor: getProductColor(product.type) + '15' }]}>
                    <Text style={[styles.productTypeText, { color: getProductColor(product.type) }]}>
                      {product.type}
                    </Text>
                  </View>
